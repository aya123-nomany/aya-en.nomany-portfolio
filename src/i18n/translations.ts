...
export const translations: Record<Language, TranslationStructure> = {
  fr: {
    ...
    techStack: {
      ...
      techs: [
        { name: "React", desc: "Bibliothèque JavaScript pour créer des interfaces utilisateur" },
        ...
        { name: "XML", desc: "Langage de balisage pour le stockage et transport de données" }
      ]
    },
    contact: {
      title: "Prenez",
  ...
  en: {
    ...
    techStack: {
      ...
      techs: [
        { name: "React", desc: "JavaScript library for building user interfaces" },
        ...
        { name: "XML", desc: "Markup language for data storage and transport" }
      ]
    },
    contact: {
      title: "Get In",
  ...
  ar: {
    ...
    techStack: {
      ...
      techs: [
        { name: "React", desc: "مكتبة JavaScript لبناء واجهات مستخدم حديثة وتفاعلية" },
        ...
        { name: "XML", desc: "لغة هيكلة ونقل البيانات" }
      ]
    },
    contact: {
      title: "تواصل",
